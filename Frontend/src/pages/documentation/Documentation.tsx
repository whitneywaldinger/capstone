...
We've seen an immense growth in the availability and use of chatbots in our daily lives. With applications like ChatGPT, Gemini, and Vercel.ai, information has never been more easily and efficiently accessible. We wanted to capitalize on this idea and provide the researchers at the Alaska Center for Energy and Power with their own personal research assistant. Our project optimizes the data retrieval process beginning with thousands of research documents, PDFs, and ending with a user-friendly Chatbot UI. This project utilizes a RAG model and is finetuned for energy-related research.  
...
Once you are ready to deploy your application, you can  build the app for production into the build folder. 
...
For webpage deployment, we are using Cloudflare Pages. Cloudflare Pages offers several advantages for hosting your webpage, particularly if it's a static website.  It simplifies deployment with seamless Git integration, allowing your UI to automatically update with each push.  Second, Cloudflare's global network ensures fast delivery of your chatbot UI to users worldwide, and built-in SSL takes care of security concerns.  (While this is not the most important concern for our project, when deploying this project for different use cases it could be very valuable.) Finally, the free tier provides unlimited websites and bandwidth, making it a cost-effective option for personal projects or small-scale deployments.  By leveraging Cloudflare Pages' infrastructure, you can focus on development and ensure your chatbot UI remains accessible and performs well, even with unexpected traffic spikes. 
